...
$user_Name = $_POST['auto_user_name'];
$user_Phone = $_POST['auto_user_phone'];
$user_Massege = $_POST['auto_user_massege'];
...
// отправляем письмо
  ...
  if($result){
      echo "Сообщение отправлено. Спасибо Вам  . $auto_user_name . , мы скоро свяжемся с Вами. <br /><br /><a href='#' onclick='goBack();'>Вернуться на сайт.</a>";
  }else{
      echo "Сообщение отправлено. Спасибо Вам  . $auto_user_name . , мы скоро свяжемся с Вами. <br /><br /><a href='#' onclick='goBack();'>Вернуться на сайт.</a>";
  }
